      ...
      <div className="max-w-2xl mx-auto p-3 text-center">
        ...
        <h1 className='text-3xl font font-semibold text-center my-7'>
          ...
          <p> Welcome to Amrutha's Blog! This blog was created by Amrutha Pandavula as a personal project to share his thoughts and ideas with the world. Amrutha is a aspiring mern stack developer looking for an oppurtunity as a fresher </p>
            <p> On this blog, you'll find weekly articles and tutorials on topics  such as web development, software engineering, and programming  languages. Amrutha is always learning and exploring new  technologies, so be sure to check back often for new content!</p>
